...
void MultiScaleTransforms::Transform(std::initializer_list<double*> images, double* scratch, double scale)
{
...
void MultiScaleTransforms::Transform(ao::uvector<double*> images, double* scratch, double scale)
{
	ao::uvector<double> shape;
	size_t kernelSize;
	makeShapeFunction(scale, shape, kernelSize);
